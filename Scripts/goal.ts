...
function addGoal() {
    ...
    fetch(uri, {
      ...
      .then(() => {
        getGoals();
        description.value = '';
        var modal: HTMLElement = document.querySelector("#exampleModal");
...
function _displayGoals(data) {
    ...
    data.forEach(item => {
        ...
        var card: HTMLElement = bs4Card(item.description);
...
var form: HTMLFormElement = <HTMLFormElement> document.getElementById("goal-form");
